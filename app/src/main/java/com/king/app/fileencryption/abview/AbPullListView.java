...
public class AbPullListView extends ListView implements OnScrollListener {
	...
	public void setOnMyListScrollListener(OnScrollListener l) {
		this.listener=l;
	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		if((firstVisibleItem+visibleItemCount+1)==totalItemCount&&mEnablePullLoad&& !mPullLoading&&!mPullRefreshing){
			startLoadMore();
		}
